#############################################################################
# Makefile for building: ray-tracer.app/Contents/MacOS/ray-tracer
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  ray-tracer.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile ray-tracer.pro
#############################################################################
...
CFLAGS        = -pipe -O2 $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk -mmacosx-version-min=13.0 -Wall -Wextra -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -std=c++11 -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk -mmacosx-version-min=13.0 -Wall -Wextra -fPIC $(DEFINES)
INCPATH       = -I. -I../../../../Downloads/libQGLViewer-2.9.1 -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/AGL.framework/Headers -I/usr/local/lib/QtOpenGLWidgets.framework/Headers -I/usr/local/lib/QtOpenGL.framework/Headers -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtXml.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/AGL.framework/Headers -I/usr/local/share/qt/mkspecs/macx-clang -F/usr/local/lib
...
DISTDIR = /Users/huseyinyurtseven/Documents/MasterCours/InfoGraphique.nosync/TP2_Info804/.tmp/ray-tracer1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk -mmacosx-version-min=13.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/usr/local/lib
LIBS          = $(SUBLIBS) -F/usr/local/lib -F/Users/huseyinyurtseven/Downloads/libQGLViewer-2.9.1/QGLViewer -framework QGLViewer -framework QtOpenGLWidgets -framework QtOpenGL -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtXml -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/macx.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/sanitize.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/gcc-base-mac.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/clang-mac.conf \
...
DESTDIR       = 
TARGET        = ray-tracer.app/Contents/MacOS/ray-tracer
...
EXPORT__PRO_FILE_ = /Users/huseyinyurtseven/Documents/MasterCours/InfoGraphique.nosync/TP2_Info804/ray-tracer.pro


include /usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

ray-tracer.app/Contents/MacOS/ray-tracer:  $(OBJECTS)  
	@test -d ray-tracer.app/Contents/MacOS/ || mkdir -p ray-tracer.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ray-tracer.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.4.2_1/share/qt/mkspecs/common/macx.conf \
		...
		/usr/local/share/qt/mkspecs/features/lex.prf \
		ray-tracer.pro \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/QGLViewer.framework/Resources/QGLViewer.prl \
...
ray-tracer.app/Contents/PkgInfo: 
	@test -d ray-tracer.app/Contents || mkdir -p ray-tracer.app/Contents
	@$(DEL_FILE) ray-tracer.app/Contents/PkgInfo
	@echo "APPL????" > ray-tracer.app/Contents/PkgInfo
ray-tracer.app/Contents/Resources/empty.lproj: 
	@test -d ray-tracer.app/Contents/Resources || mkdir -p ray-tracer.app/Contents/Resources
	@touch ray-tracer.app/Contents/Resources/empty.lproj
	
ray-tracer.app/Contents/Info.plist: 
	@test -d ray-tracer.app/Contents || mkdir -p ray-tracer.app/Contents
	@$(DEL_FILE) ray-tracer.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.ray-tracer,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.ray-tracer,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,ray-tracer,g" -e "s,@LIBRARY@,ray-tracer,g" -e "s,\$${EXECUTABLE_NAME},ray-tracer,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >ray-tracer.app/Contents/Info.plist

all: Makefile \
		ray-tracer.app/Contents/PkgInfo \
		ray-tracer.app/Contents/Resources/empty.lproj \
		ray-tracer.app/Contents/Info.plist ray-tracer.app/Contents/MacOS/ray-tracer
...
Viewer.o: Viewer.cpp Viewer.h \
		...
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/qglviewer.h \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/camera.h \
		/usr/local/lib/QtCore.framework/Headers/QMap \
		/usr/local/lib/QtCore.framework/Headers/qmap.h \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/keyFrameInterpolator.h \
		...
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/quaternion.h \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/vec.h \
		/usr/local/lib/QtXml.framework/Headers/QDomElement \
		/usr/local/lib/QtXml.framework/Headers/qdom.h \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/config.h \
		...
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/frame.h \
		/usr/local/lib/QtCore.framework/Headers/QString \
		/usr/local/lib/QtCore.framework/Headers/qstring.h \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/constraint.h \
...
ray-tracer.o: ray-tracer.cpp /usr/local/lib/QtWidgets.framework/Headers/qapplication.h \
		Viewer.h \
		/usr/local/lib/QtGui.framework/Headers/QKeyEvent \
		/usr/local/lib/QtGui.framework/Headers/qevent.h \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/qglviewer.h \
		...
		Sphere.h \
		PointLight.h \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/manipulatedFrame.h \
		../../../../Downloads/libQGLViewer-2.9.1/QGLViewer/mouseGrabber.h \
